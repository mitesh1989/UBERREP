...
{
    public partial class SalesList : System.Web.UI.UserControl
    {
        ...
        public void BindReapeater()
        {
            ...
            spData.Add("type",Convert.ToString((int)BusinessLayer.Users.UserTypes.Sales));
        ...
        protected void UserListRPT_ItemCommand1(object source, RepeaterCommandEventArgs e)
        {
