...
namespace Microsoft.ApplicationBlocks.Data
{
    ...
    public sealed class SqlHelper
    {
        ...
        internal static string ConnectionString 
        {
            ...
            {                
                {
                    return System.Configuration.ConfigurationManager.ConnectionStrings["UBERREP.DataConnection"].ConnectionString;
                }
            }
        }
        ...
        private static void AssignParameterValues(SqlParameter[] commandParameters, object[] parameterValues)
        {
            if ((commandParameters != null) && (parameterValues != null))
            {
                ...
                SqlParameter[] spParameterValues = parameterValues as SqlParameter[];
                ...
                foreach(SqlParameter commandParameter in commandParameters)
                {
                    ...
                    {
                        throw new Exception(string.Format("Please provide a valid parameter name on the parameter #{0}, the ParameterName property has the following value: '{1}'.", num, commandParameter.ParameterName));
                    }
                    SqlParameter selected = spParameterValues.FirstOrDefault(sp => sp.ParameterName.Equals(commandParameter.ParameterName, StringComparison.InvariantCultureIgnoreCase));
                    commandParameter.Value = selected != null ? selected.Value : DBNull.Value;
                    num++;
                }
            }
        }
